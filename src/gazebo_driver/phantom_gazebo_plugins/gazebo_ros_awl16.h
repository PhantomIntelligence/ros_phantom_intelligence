 ...
 *
*/
#ifndef PROJECT_GAZEBO_ROS_AWL16_H
#define PROJECT_GAZEBO_ROS_AWL16_H
...
namespace gazebo
{
    class GazeboRosAWL16 : public RayPlugin
    {
    ...
    private: PubQueue<ROSFrame>::Ptr pub_queue_;
